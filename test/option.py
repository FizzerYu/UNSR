...
parser = argparse.ArgumentParser(description='PFFN')
...
parser.add_argument('--dir_data', type=str, default='/home/chenjunming/fizzer/self_imdn/code', # 需要同时有 benchmark and DIV2K 文件
...
parser.add_argument('--ext', type=str, default='img',  #"sep_reset" or "bin_reset" 
...
parser.add_argument('--model', default='RCAN',
                    help='model name')
parser.add_argument('--model_choose', default='RCAN',
                    help='custom args; same model may have different implement->ref imdn')
